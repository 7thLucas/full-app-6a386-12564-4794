...
export const configurableSchemas: ConfigurableSchemas = {
  formSchema: [
    ...
    {
      fieldName: "feedWelcomeMessage",
      type: "string",
      required: false,
      label: "Feed Welcome Message",
      maxLength: 80,
    },
    {
      fieldName: "feedComposerPlaceholder",
      type: "string",
      required: false,
      label: "Post Composer Placeholder",
      maxLength: 100,
    },
    {
      fieldName: "feedMaxPlaceholderCards",
      type: "number",
      required: false,
      label: "Max Placeholder Feed Cards",
      min: 2,
      max: 20,
    },
    {
      fieldName: "showProfileStrip",
      type: "boolean",
      required: false,
      label: "Show Profile Strip",
    },
    {
      fieldName: "aboutText",
      type: "string",
